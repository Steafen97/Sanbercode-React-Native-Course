    ...
    return (
      <View style={styles.container}>
            ...
            <View style={styles.logo}>
                <Image source={require('./assets/images/fotoprofil.jpg')} style={styles.fotoProfil}/>
            </View>

            <View style={styles.profil}>
                <Text style={styles.textName}>Steafen Kristian Soegiono</Text>
                ...
                <View>
                 ...
                 <View style={styles.protofolio}>
                    <View style={styles.daftarPortofolio}>
                        ...
                        <Text style={styles.txtPort1} >@steafen97 </Text>
                    </View>
            ...
            <View>
                <ImageBackground style={styles.backHubungi}>
                    ...
                    <View style={styles.kontak}>
                        ...
                        <Text style={{ color:"#003366", fontWeight:"bold", fontSize:16}}>Steafen Kristian</Text>
                    </View>
                    <View style={styles.kontak}>
                        <Icon name="instagram" size={25}  color="#3EC6FF" />
                        <Text style={{ color:"#003366", fontWeight:"bold", fontSize:16}}>@steafenkristian</Text>
                    </View>
                    <View style={styles.kontak}>
